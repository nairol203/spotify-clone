                ...
                <div>
                    {recentTracks.data ? (
                        recentTracks.data.items.map((item, index) => (
                            <div
                                className='flex items-center justify-between gap-2 rounded-[4px] px-4 py-2 md:hover:bg-black md:hover:bg-opacity-10 md:hover:dark:bg-white md:hover:dark:bg-opacity-10'
                                        ...
                                        <div className='flex flex-wrap items-center gap-1'>
                                            ...
                                            {item.track.artists.map((artist, index) => (
                                                <div className='dark:text-gray-300' key={artist.id + index}>
                                                    <a className='text-sm hover:underline' href={artist.external_urls.spotify} target='_blank' rel='noreferrer'>
                                                        {artist.name}
                                                    </a>
